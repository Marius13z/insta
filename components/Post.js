...
function Post({ id, username, userImg, img, caption }) {
  ...
  return (
    ...
    <div className="flex items-center p-5">
        <img referrerpolicy="no-referrer" src={userImg} className="rounded-full h-12 w-12 object-contain border p-1 mr-3" alt="profile pic"/>
        ...
        {comments.length > 0 && (
          <div className="ml-10 h-20 overflow-y-scroll scrollbar-thumb-black scrollbar-thin">
              {comments.map(comment => {
                return (<div className="flex items-center space-x-2 mb-3 " key={comment.id}>
